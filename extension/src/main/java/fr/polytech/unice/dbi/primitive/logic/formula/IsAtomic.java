package fr.polytech.unice.dbi.primitive.logic.formula;
...
/**
 * This class implements a fr.polytech.unice.dbi.primitive that tell if a Formula is atomic or not and returns this result as a boolean
 */
